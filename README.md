...
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/alexreardon/@f1stnpm2/ducimus-incidunt-natus/test.yml)
![types](https://img.shields.io/badge/types-typescript%20%7C%20flow-blueviolet)
![npm bundle size](https://img.shields.io/bundlephobia/minzip/@f1stnpm2/ducimus-incidunt-natus)
![NPM Downloads](https://img.shields.io/npm/dm/@f1stnpm2/ducimus-incidunt-natus)

`@f1stnpm2/ducimus-incidunt-natus` is a _tiny_, widely-supported, zero-dependency alternative to [`invariant`](https://www.npmjs.com/package/invariant).
